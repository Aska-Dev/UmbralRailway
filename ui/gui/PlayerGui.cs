...
public partial class PlayerGui : Control
{
    ...
    private UiSceneData mapData = null!;
    ...
    public override void _Ready()
	{
        ...
        var mapScene = GD.Load<PackedScene>("res://ui/gui/Map/Map.tscn");
        ...
        mapData = new UiSceneData(mapScene);
        ...
        UiEventBus.Instance.MapToggled += (bool isOpen) => mapData.Toggle(isOpen, this);
    }
